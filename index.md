...
venue: "UM OFF SITE LOCATION"        # brief name of host site without address (e.g., "Euphoric State University")
address: "1234 STREET AA, MI 48108"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["jfuen", "r. a. ndo", "r. ando"] # boxed, comma-separated list of instructors' names as strings, like ["jfuen", "r. a. ndo", "r. ando"]
